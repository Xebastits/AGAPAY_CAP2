...
export const ApproveCampaignModal = ({
  ...
  const handleItemClick = (imageUrl: string | undefined, label: string) => {
    if (!imageUrl) return;
          ...
          <div className="flex flex-1 overflow-hidden">
            ...
            <div className="w-1/2 border-r flex flex-col overflow-y-auto p-5 gap-4">
              ...
              <div className="p-3 bg-yellow-50 border border-yellow-200 rounded text-sm text-yellow-800">
                <strong>Notice:</strong> Click each item to preview its document, then check it off.
              </div>

              <div className="space-y-2">
                {CHECKLIST_ITEMS.map((item) => {
                  const imageUrl = images?.[item.imageKey];
                  const isActive = activeImage === imageUrl && !!imageUrl;
                  ...
                  return (
                    <div
                      ...
                      `}
                      onClick={() => handleItemClick(imageUrl, item.label)}
                    >
                      <input
                        type="checkbox"
              ...
              {/* Campaign image preview thumbnail */}
              {images?.campaignImage && (
                <div>
                  ...
                  <div
                    ...
                    onClick={() => handleItemClick(images.campaignImage, "Campaign Image")}
                  >
            ...
            <div className="w-1/2 flex flex-col items-center justify-center bg-slate-50 p-5">
              {activeImage ? (
                <>
                  <p className="text-xs font-bold text-slate-500 uppercase mb-3 text-center">{activeLabel}</p>
                ...
                <div className="text-center text-slate-400">
                  ...
                  <p className="text-sm">Click a checklist item to preview its document</p>
                </div>
              )}
            </div>
          </div>
